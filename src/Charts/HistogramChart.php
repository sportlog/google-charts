...
class HistogramChart extends GoogleChart {
     ...
     */
    public function __construct(string $id, public readonly HistogramChartOptions $options = new HistogramChartOptions())
    {
        parent::__construct($id, ChartType::Histogram, $options);
    }
}